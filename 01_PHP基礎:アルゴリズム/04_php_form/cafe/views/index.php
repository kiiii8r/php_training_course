...
<body>
  ...
  <?php include 'shared/top_header.html'?>
  ...
  <main>
    ...
    <section class="bg_black" id="experience">
      <h2>カフェ作りを体験しよう</h2>
      ...
      <div class="experience">
        ...
        <div class="box">
          <div class="info">
            <div class="photo">
              <img src="../img/exp3.jpg" alt="プロモーション">
            </div>
  ...
  <div id="jump" class="jump">Jump To Top</div>
